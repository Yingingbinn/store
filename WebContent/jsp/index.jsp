<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@taglib prefix="fa" uri="http://java.sun.com/jsp/jstl/functions" %>
<!DOCTYPE html>
<html>
			...
			<div class="container-fluid">
				...
				<c:forEach items="${listh }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath }/productServlet?method=getBypid&pid=${p.pid}" style='color:#666'>${fa:substring(p.pname,0,12)  }...</a></p>
